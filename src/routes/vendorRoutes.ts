...
router.post(
  ...
  vendorAuthController.changeForgotPassword.bind(vendorAuthController),
);
router.get(
...
router.get(
  ...
  authenticateToken,
  authorizeRole(AuthRole.VENDOR),
  vendorProfileController.getVendorWithAll.bind(vendorProfileController),
);
...
router.get(
  ...
  authenticateToken,
  authorizeRole(AuthRole.VENDOR),
  vendorAvailablilityController.showUnavailableDates.bind(vendorAvailablilityController),
);
router.post(
  '/dateAvailabilty',
  authenticateToken,
  authorizeRole(AuthRole.VENDOR),
  vendorAvailablilityController.addUnavailableDates.bind(vendorAvailablilityController),
);
router.post(
  '/dateAvailabilty/unblock',
  authenticateToken,
  authorizeRole(AuthRole.VENDOR),
  vendorAvailablilityController.removeUnavailableDates.bind(vendorAvailablilityController),
);
