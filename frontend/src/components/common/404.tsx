              ...
              <g id="OBJECTS">
                ...
                <g id="Group_8">
                  <g id="Group_9">
                    ...
                    <g
                      id="handboy"
                      className="animate-swing transform-origin-[98%_98%] transform-box-fill-box"
                    >
                      <path
                        id="Vector_32"
                ...
                <g id="Group_13">
                  <g id="Group_14">
                    ...
                    <g
                      id="girllight"
                      className="animate-swing transform-origin-[0%_97%] transform-box-fill-box"
                    >
                      <path
                        id="Vector_102"
                    ...
                    <g
                      id="hairgirl"
                      className="animate-swinghair transform-origin-[60%_0%] transform-box-fill-box"
                    >
                      <path
                        id="Vector_108"
