...
import type { VendorProps } from "@/utils/interface";
            ...
            <div className="container mx-auto px-4">
              <div className="flex flex-col md:flex-row items-center md:items-start space-y-8 md:space-y-0 md:space-x-8">
                <div className="w-full md:w-1/2">
                  <img
                    src={
                      ...
                      "/images/p5.jpg?height=300&width=300"
                    }
                    alt="Founder"
                ...
                <div className="w-full md:w-1/2 text-center md:text-left my-5 mx-3">
                  ...
                  <p className="mb-4 text-gray-600">{vendorDetails?.about}</p>
                  ...
                  <button
                    className="bg-red-800 text-white px-6 py-2 rounded-full hover:bg-red-700 transition duration-300 ml-2"
