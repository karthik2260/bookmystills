...
const HeroSection = () => {
  ...
  const CarouselNavigation = useCallback(
    ({ setActiveIndex, activeIndex, length }: CarouselNavigationProps) => (
  ...
  const viewPorfolio = useCallback(
    (vendorId: string) => {
      ...
      <section className="bg-white py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h3 className="text-xl text-yellow-600 font-light tracking-wide mb-2">
              MOMENTS
            </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            {services.slice(0, 3).map((service, index) => (
              <div key={index} className="flex flex-col items-center">
                ...
                <h3 className="text-xl font-serif font-light mb-4 text-gray-900">
                  {service.title}
                </h3>
