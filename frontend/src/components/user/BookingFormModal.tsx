...
import { BookingModalProps,ValidationError } from '@/utils/interface';
export const BookingModal: FC<BookingModalProps> = ({
    ...
    useEffect(() => {
        if (selectedDate) {
            ...
            setCurrentMonth(new Date(parseInt(yearStr, 10), parseInt(monthStr, 10) - 1));
        }
    }, [selectedDate, isOpen]);
    ...
    if (bookingForm.selectedDate && unavailableDates.includes(bookingForm.selectedDate)) {
        setValidationErrors(prev => ({
            ...prev,
            selectedDate: 'Selected date is unavailable. Please choose another date.',
        }));
    ...
    try {
        ...
        if (error && typeof error === 'object' && 'inner' in error) {
            ...
            ve.inner?.forEach(err => { if (err.path) errors[err.path] = err.message; });
            setValidationErrors(errors);
        }
    } finally {
        setIsSubmitting(false);
                    ...
                    <>
                        ...
                        <ModalBody>
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <Input
                                        ...
                                        onChange={e => {
                                            ...
                                            handleInputChange('noOfDays', Math.min(Math.max(value, 1), 2));
                                        }}
                                ...
                                <Input
                                    ...
                                    onBlur={() => validateField('fullAddress', bookingForm.fullAddress)}
                                ...
                                <div className="grid grid-cols-3 gap-4">
                                    ...
                                    <Input
                                        ...
                                        onBlur={() => validateField('landmark', bookingForm.landmark)}
                        ...
                        <ModalFooter>
                            ...
                            <Button
                                ...
                                endContent={isSubmitSuccess ? <CheckIcon className="w-5 h-5" /> : null}
                            >
