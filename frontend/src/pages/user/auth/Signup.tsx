      ...
      <div className="w-full md:w-1/2 flex items-center justify-center bg-gray-50 px-6 py-8 overflow-y-auto">
        <GoogleOAuthProvider clientId={client_id}>
          <div className="w-full max-w-md space-y-5">
            ...
            {/* Header */}
            <div>
              <p className="text-xs font-semibold uppercase tracking-widest text-blue-600 mb-1">Get started</p>
              <h2 className="text-3xl font-bold text-gray-900">Create your account</h2>
              <p className="text-sm text-gray-500 mt-1">Fill in your details to join EventPro</p>
            </div>
            ...
            <form onSubmit={submitHandler} className="space-y-4">
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <input
                    id="contactinfo" type="text" name="contactinfo"
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  <Lock size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400" />
                  <input
                    id="confirm-password" name="confirmPassword" autoComplete="new-password"
                    type={showPassword1 ? "text" : "password"} placeholder="••••••••"
            ...
            <div className="flex justify-center">
              <GoogleLogin
                ...
                onError={() => showToastMessage("Google signup failed", "error")}
              />
            </div>
            ...
            <p className="text-center text-sm text-gray-500">
              ...
              <Link to={USER.LOGIN} className="text-blue-600 font-semibold hover:underline">Login</Link>
            </p>
            <p className="text-center text-sm text-gray-500 pb-4">
              Would you like to be a vendor?{' '}
              <Link to={VENDOR.SIGNUP} className="text-blue-600 font-semibold hover:underline">Sign up here</Link>
            </p>
