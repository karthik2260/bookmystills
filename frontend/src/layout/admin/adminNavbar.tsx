       ...
       {...({} as any)}>
        <div className="flex items-center justify-between">
          ...
          <div className="hidden sm:flex gap-6 md:gap-8 lg:gap-10 items-center text-white ">
            <Typography as="a" href={ADMIN.DASHBOARD} className="cursor-pointer font-semibold  text-md md:text-base lg:text-lg hover:text-gray-300 transition-all" placeholder={undefined}
           {...({} as any)}>
              ADMIN PANNEL SAMPLE 
            </Typography>
        ...
        <MobileNav open={openNav}>
          <div className="flex flex-col gap-4 items-center text-white">
            <Typography as="a"  className="cursor-pointer text-lg" placeholder={undefined}
          {...({} as any)}>
              HOME
            </Typography>
            <Typography as="a"  className="cursor-pointer text-lg" placeholder={undefined}
